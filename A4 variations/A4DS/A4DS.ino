...
#define NUM_LEDS_ARRAY 255 // Number of LED's in the strip
...
#define MIN_AMPLITUDE 645 // Lowest possible amplitude value (Higher number causes there to be more blank LED's)
