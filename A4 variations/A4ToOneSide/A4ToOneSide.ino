...
#define NUM_LEDS 200 // Number of LED's in the strip
...
#define LEFT_START_POINT (2) // Starting LED for left side
#define LEFT_END_POINT 1 // Generally the end of the left side is the first LED
#define RIGHT_START_POINT (1) // Starting LED for the right side
