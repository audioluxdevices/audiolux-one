...
NeoPatterns Ring1(100, 6, NEO_RBWG + NEO_KHZ800, &Ring1Complete);
...
void setup()
{
  Serial.begin(115200);
   ...
   pinMode(5, INPUT_PULLUP);
    ...
    // Kick off a pattern
    Ring1.TheaterChase(Ring1.Color(255,255,0,0), Ring1.Color(0,0,50,0), 100);
}
...
void loop()
{
    ...
    {
        // Switch Ring1 to COLOR_WIPE pattern
...
void Ring1Complete()
{
    if (analogRead(2) >= 100)  // Pot #1 More than 100
    {
        Ring1.Color1 = Ring1.Wheel(map(analogRead(3), 0, 1023, 0, 255)); //map right pot knob to 0-255 values of hue
